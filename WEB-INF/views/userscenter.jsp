...
<body onLoad="pageLoad('')">
	<div id="wrap" style="position: relative; z-index: 1;">
		...
		<!-- Banner End -->
		<!-- Content -->
		<div id="servicecenter" style="display: block">
			<div style="height: 90vh; display: flex; justify-content: space-around; position: relative; top: 30%; background: #1f5b8308;">
				<div class="content"
					style="display: flex; gap: 1%; justify-content: center; width: 100%; position: absolute; height: 80%; top: 10%;">
						...
						<div class="card-body" style="overflow-y: auto; height: 70vh;">
							<ul class="nav nav-tabs" role="tablist">
								<li class="nav-item" role="presentation"><a
									class="nav-link a active" data-bs-toggle="tab" href="#home"
									aria-selected="false" role="tab" tabindex="0">분실물 신고절차</a></li>
								<li class="nav-item" role="presentation"><a
									class="nav-link a" data-bs-toggle="tab" href="#profile"
									aria-selected="false" role="tab" tabindex="1">습득물 신고절차</a></li>
								<li class="nav-item" role="presentation"><a
									class="nav-link a" data-bs-toggle="tab" href="#dropdown1"
									aria-selected="false" role="tab" tabindex="2">분실물 처리절차</a></li>
								<li class="nav-item" role="presentation"><a
									class="nav-link a" data-bs-toggle="tab" href="#dropdown2"
									aria-selected="false" role="tab" tabindex="3">습득물 처리절차</a></li>
							</ul>
							<div id="myTabContent" class="tab-content">
								<div class="tab-pane fade active show" id="home" role="tabpanel">
									<p>
										<h1>분실물 신고절차 안내문</h1>
									<br> <br> 1.Lost and Found 내에서
									<h2>분실물신고 절차</h2>
									<br> <br> ＊ Lost and Found에서는 분실물 상담 센터를 운영하고 있습니다.
									아래 항목에 따라 자신의 분신물을 신고해 주세요. <br> <br> 1.분실한 제품명: <br>
									2.이미지(필히 등록해주세요.): <br> 3.분실한 지역(시,군,구): <br> 4.분실장소
									또는 예상장소: <br> 5.분실 날짜: <br> 6.색상: <br> Lost and
									Found에서는 분실신고 되어있는 물품은 공공기관의 정보와 서비스를 동원해 찾을 수 있도록 최선의 노력을
									다하겠습니다. 상담이 필요하시다면 언제든지 문의 글에 문의해주세요. <br> <br> 2.경찰청
									홈페이지 분실 신고 절차 - Lost112 경찰청 홈페이지에 접속
									<홈페이지 주소 : https://www.lost112.go.kr/index.do> <br>
									- 회원가입 후 로그인 or 로그인 <br>
									-분실물 신고 -분실물 신고 화면에서 양식에 맞추어 신고 내용을 입력한 후 저장 버튼을 클릭하면, 신고가
									접수됩니다. (분실시간을 정확히 입력해 주셔야 합니다.)
									</p>
								</div>
								<div class="tab-pane fade" id="profile" role="tabpanel">
									...
									<br> <br> 1.Lost and Found 내에서
									<h2>습득신고 절차</h2>
									<br> <br> ＊ Lost and Found에서는 습득물 상담 센터를 운영하고 있습니다.
									아래 항목에 따라 자신의 습득물을 신고해 주세요. <br> <br> 2.이미지(필히
									등록해주세요.): <br> 3.습득한 지역(시,군,구): <br> 4.습득장소 또는 예상장소:
									<br> 5.습득 날짜: <br> 6.색상: <br> Lost and Found에서는
									습득신고 되어있는 물품은 공공기관의 정보와 서비스를 동원해 찾을 수 있도록 최선의 노력을 다하겠습니다. 상담이
									필요하시다면 언제든지 문의 글에 문의해주세요. <br> <br> 2.경찰청 홈페이지 습득 신고
									절차 - Lost112 경찰청 홈페이지에 접속 <br>
									<홈페이지 주소 : https://www.lost112.go.kr/index.do> <br>
									- 회원가입 후 로그인 or 로그인 <br>
									-습득물 신고
									</p>
								...
								<div class="tab-pane fade" id="dropdown1">
									...
									<br> Lost and Found에서는 <br> <br> 1. 경찰청의 최근 6개월과
									서울시의 최근 1주일 연계된 데이터를 받아옵니다. <br> 2.분실자는 Lost and Found의 분실
									신고 글 등록을 통해 분실물의 정보를 입력합니다. <br> 3.분실물 신고가 접수되고 경찰청과 서울시의
									습득물 데이터를 분실자가 분실물을 검색 시 대조합니다. <br> 4.분실물에 대한 전체 게시글이
									표시됩니다. <br> 5.분실자는 상세페이지의 정보를 통하여 분실한 물건의 정보를 제공받습니다. <br>
									6.분실자는 관할서의 문의전화 또는 내방을 통하여 분실물을 습득하실 수 있습니다. <br> Lost
									and Found에서는 분실처리 물품을 공공기관의 정보와 서비스를 동원해 찾으실 수 있도록 최선의 노력을
									다하겠습니다. 상담이 필요하시다면 언제든지 문의 글에 문의해주세요. <br> <br> 2.경찰청
									홈페이지 분실 처리 절차 - Lost112 경찰청 홈페이지에 접속
									<홈페이지 주소 : https://www.lost112.go.kr/index.do> <br>
									- 회원가입 후 로그인 or 로그인 <br>
									-유실물 종합안내 <br>
									-분실물 처리절차 조회
								...
								<div class="tab-pane fade" id="dropdown2">
									...
									<br> <br> 1.Lost and Found 내에서
									<h2>습득물 처리 절차</h2>
									<br> <br> ＊Lost and Found에서는 습득물 처리 글 센터를 운영하고 있습니다.
									Lost and Found에서는 <br> <br> 1.습득자는 Lost and Found의 습득
									신고 글 등록을 통해 습득물의 정보를 입력합니다. <br> 3.습득물 신고가 접수되고 경찰청과 서울시의
									습득물 데이터는 분실자가 분실물을 검색 시 대조됩니다. <br> 4.습득물에 대한 전체 게시글이
									표시됩니다. <br> 5.습득자는 상세페이지의 정보를 통하여 분실한 물건의 정보를 제공받습니다. <br>
									6.습득자는 습득물의 상세게시글을 통해 습득물에 대한 코멘트를 작성하실 수 있습니다. <br> Lost
									and Found에서는 습득처리 물품을 공공기관의 정보와 서비스를 동원해 찾으실 수 있도록 최선의 노력을
									다하겠습니다. 상담이 필요하시다면 언제든지 문의 글에 문의해주세요. <br> <br> 2.경찰청
									홈페이지 습득물 처리 절차 - Lost112 경찰청 홈페이지에 접속
									<홈페이지 주소 : https://www.lost112.go.kr/index.do> <br>
									- 회원가입 후 로그인 or 로그인 <br>
									-유실물 종합안내 <br>
									-습득물 처리절차 조회
		...
		if(serverData.minfo.alarm!=''){
			...
			for(let i=0; i<serverData.minfo.alarm.length;i++){
				...
				button.addEventListener('click', function() {
					event.stopPropagation(); 
					alarmDelete(serverData.minfo.alarm[i].maLaCtNumber);
				});
	...
	function moveAlarmDetail(){
		...
		if(arguments[0]!=0){
			...
			if(document.getElementById("servicecenter").style.display == 'block'){
				document.getElementById("servicecenter").style.display = 'none';
				status=1;			
			}
			...
			if(status==1)
				document.getElementById("servicecenter").style.display = 'block';
...
window.addEventListener('scroll', function() {
	...
	function quetionCtl(){
		if(arguments[0]==0){
			document.getElementById('quetionpost').style.display = 'none';
			document.getElementById('quetiondetail').style.display = 'none';
		}
		else if(arguments[0]==1){
			document.getElementById('quetionpost').style.display = 'block';
			document.getElementById('quetiondetail').style.display = 'none';
		}else{
			document.getElementById('quetionpost').style.display = 'none';
			document.getElementById('quetiondetail').style.display = 'block';
		}
	}
	function serviceCtl(idx) {
		if (idx == 7) {
			document.getElementById("guide").style.display = 'none';
			document.getElementById("quetion").style.display = 'block';
		} else {
			document.getElementById("quetion").style.display = 'none';
			document.getElementById("guide").style.display = 'block';
			document.getElementsByClassName("nav-link a")[idx].click();
		}
	}
