...
<body onLoad="pageLoad('')">
		...
		<div id="mypage" style="display: block">
			<div
				...
				<div class="content"
					...
					<div id="modmypage" class="card"
						style="display: block; margin-left: inherit; width:65vh;">
						<div class="card-body" style="width: 100%; margin-top:40px;">
							<h4 class="card-title" id="mmnickname"></h4>
							<h6 class="card-subtitle mb-2 text-muted">일반 회원</h6>
							<div class="form-group row">
										<label for="inputExperience" class="col-sm-2 col-form-label">닉네임</label>
										<div class="col-sm-10">
							...
							<div style="width: 100%; text-align: center; padding: 10%">
										<div style="width: 30%" class="btn btn-primary"
											onclick="modUser2()">수정</div>
							<hr>
							<p class="card-text" id="mmemail"></p>
							<p class="card-text" id="mmphone"></p>
							<p class="card-text" id="mmsns"></p>
						</div>
						<div class="card-body" style="width: 100%;">
							<div class="tab-pane" id="settings">
								<form class="form-horizontal">
									<div class="form-group row">
										<label for="inputExperience" class="col-sm-2 col-form-label">전화번호</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="modphone"
	...
	function modUser1(){
		...
		formData.set("serviceCode","U30");
		formData.set('temp',document.getElementById("modphone").value);
		console.log(modphone);
		serverCallByFetchAjax(formData, '/Api/getBannerData', 'post', 'bannerCallBack');
	}
	function modUser2(){
		let formData = new FormData();
		formData.set("serviceCode","U32");
		formData.set('temp',document.getElementById("modname").value);
		serverCallByFetchAjax(formData, '/Api/getBannerData', 'post', 'bannerCallBack');
	}
	function pageLoad(){
	...
	function updateMember(){
		document.getElementById("mmnickname").innerText="닉네임 : "+bannerData.member.mmName;
		document.getElementById("mmemail").innerText="이메일 : "+bannerData.member.mmEmail;
		document.getElementById("mmphone").innerText="연락처 : "+bannerData.member.mmPhone;
		document.getElementById("mmsns").innerText="SNS : "+((bannerData.member.mmSns=='UK')?'카카오':
													(bannerData.member.mmSns=='UN')?'네이버':'구글');
	}
